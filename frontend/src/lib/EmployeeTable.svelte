...
<div class="relative">
    ...
    <div class="overflow-auto" style="scroll-behavior: auto;" bind:this={tableContainer}>
    ...
    <div class="sticky bottom-0 overflow-x-auto overflow-y-hidden bg-gray-50 border-t border-gray-300 h-5 scrollbar-container" 
         style="scroll-behavior: auto;" bind:this={stickyScrollbar}>
        <div class="h-5 w-full min-w-[800px]"></div>
    </div>
</div>